...
public class VerifySignature {
  ...
  //XML FILE
  static String xmlInput1        = "src/main/resources/PersonSignedWithKeyInfo.xml";
  static String xmlInput2        = "src/main/resources/PersonSignedWithoutKeyInfo.xml";
  ...
  public static void main(String[] args) throws Exception {
    ...
    Document    document =      documentFactory.newDocumentBuilder().parse(new FileInputStream(xmlInput2));
